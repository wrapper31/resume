...
•	Good working experience in GUI design and application development using IDE's like Eclipse/STS, IntelliJ Idea and Net Beans.
•	Expert on IBM WebSphere Portal and content management.
•	Good Working Experience on Liferay Portal/Camunda BPM
•	Experienced in Configure and Supporting monitor tools like Splunk, ELK
•	Certified on IBM CloudPak for Automation
•	Certified on ReactJS by PluralSight
...
•	13 Years in IBM DB2, Oracle, MS SQL, MySQL. 4 Years in IBM Content Manager On Demand or CMOD.
•	2 Years Liferay Portal. 
•	2 Years in FileNet
•	2 Years in Camunda BPM
•	Project Management Tool:  JIRA, ALM
•	Middleware: IBM MQ, Rabbit MQ, IBM ESB, RMI, Corba/IIOP, Webmethods, Apache Spark, Apache Camel
•	Languages: Java, C#, Python, PHP, JavaScript, Angular, ReactJS, PL/SQL, Jython, C/C++
•	Operating Systems: Windows, Linux, Unix, Mac
•	Storage : AWS S3 Storage, Azure Cloud Storage, Google Cloud Storage
•	Build Tools: Docker Build, Ant, Maven, Gradle, NPM, Bower
•	PaaS Platforms: OpenShift, PCF, GKE, AKS, CloudRun, Spring Cloud
...
•	Cloud Platform: IBM Cloud, Azure Cloud, Google Cloud, Spring Cloud, Pivotal Cloud Foundry
...
Project: 	Vehicle Application and Domain Release, IOTA (Independent Over the Air), SUSMGO (Software Update Managed Services Gateway Online), FORD Warranty and Recall, FORD Connect, Single Binary Repository for in-Vehicle downloads.
Duration:  Mar 2021 – Till Now
Description
Solutions include:
•	Microsoft Azure to Google Cloud Migration
•	Google GCP CDN for Vehicle software Storage for Over the Air Software update.
•	Securing Google and Azure CDN with Security Certificates for Vehicles for end-to-end encryption.
•	Working with Product anchors to migrate applications written in legacy system to Java based application and moving them to cloud distributed system for North America, Rest of the World and China.
•	Creating/Updating Ford Architecting documents Tech07, CBID (Common Build Intent Diagram) for new or existing initiative.

Responsibilities:
•	Work and collaborate with Innovative Enterprise and System Leaders/Architects engaged in Next Generation of Connected Vehicles and Mobility.
•	Technical analysis and Application design review of the existing services 
•	Application analysis and redesign Azure application to Google Cloud application.
•	CDN Infrastructure design on google platform
...
Description: The projects are aimed to migrate all the existing KeyBank specific Checks, Statements and Deposits from Mobius ViewDirect to IBM Content Management on Demand and allow existing application that are consuming the data from ViewDirect should have seamless integration with CMOD. This involved restructuring the existing SOAP based web services which are getting used by KeyBank’s Retail and Corporate Clients.

I was involved in designing the solution based on KeyBank infrastructure standard and Implementation.  Subject Matter Expert (SME) for Spring Boot Microservice Ecosystem, utilizing the platform to create proof of concepts (POCs) of different systems and use cases for microservices development. Develop code modules and libraries in support of microservice development with Spring Boot. Generate patterns of reuse for applications.

Solutions include:
•	CMOD  Services to introduce microservices and a multi-tenanted solution for Online archiving Solutions.
...
•	IBM Content Navigation integration and Plugin Development.
•	View direct specific Content re-indexing and migration to CMOD
•	Migration of VDR Batch jobs to CMOD batch Jobs.
•	KeyValue Deluxe – Stabilization of the loan/Mortgage platform
...
•	Demonstrated and modelled security patterns with JWT and Oauth2.
•	Researched Kubernetes deployment strategies for exposing Services through Kubernetes Ingress
•	Mentored developers and sys admins on Devops/OpenShift deployments.
•	Configured Artifactory for Maven/Java Artefact’s/libraries.
...
Description – 
The PSIM application provides a workflow process. The solution was created using IBM-BPM process designing in front end side. IBM designer studio workspace is being leveraged to develop the applications.
...
Environment: IBM BPM 8.5.7, IBM ODM, Java 7/8, Oracle 12c, WebSphere Application server 9, Hibernate 5.X, Captiva. 
...
Environment: IBM BPM 8.5.7 Standard, Process Designer, Spring based rest web services, SOAP Web Services, RAD 8.5.4, WebSphere Application server 9, IBM BPM Rest UI,  DB2, MS SQL, IBM Mainframe CICS system, Java, C#, Bootstrap 3.0., WebSocket-Sharp
...
Description –The projects PVE is the application to test and validate the design which are converted into actual artifacts and require plant based testing before moving to the mass production. 
...
Environment: IBM BPM 8.5.6 standard, Process Designer, Spring based rest webservices, SOAP Webservices, RAD 8.5.4, Java 8, WebSphere Application server 9, IBM BPM Rest UI, CEC Framework (Eclipse swing) , DB2, MS SQL, IBM Mainframe CICS system, SiteMinder/SAML2.0

Client:	      Daimler Trucks of North America
Role:	      BPM Developer		
Project:      ERS – Engineering Release System
Duration:   Oct 2014 – Oct 2015	
Description – The projects ERS is the application to release the designs of the truck or its part. To release the drawing and get it approved from multiple stack holders within the engineering team required an application which will help them to constantly monitor the design , its changes and approve to the next level. The application contained multiple type of approval inclusing FCCC and Corp design release which are completely automated. This application was standard ibm bpm headless/hybrid implementation to serve the purpose. The front end was a thick client named as CEC framework based on swing awt.
...
Environment: IBM BPM 8.5.6 standard , Process Designer,  Spring based rest webservices , SOAP Webservices , RAD 8.5.4,  Websphere Aplication server 9 , IBM BPM Rest UI, CEC Framework (Eclipse swing) , DB2, MS SQL, IBM Mainframe CICS system, IBM Blueworks live, Brazos UI.
...
Environment: Liferay Portal 6.1/6.2, Spring MVC, Spring JDBC Template Tomcat Server 5, Eclipse SDK,  JQuery, Mysql 5, JSP, Servlet, Ajax, JSTL, Maven (Build tool).
...
•	Understand customer needs and requirements to streamline / automate their processes.
...
•	Conduct plays back sessions with business and other stakeholders to demonstrate process flow and functionality.
•	Implemented services and user interfaces using Teamwork’s coaches.
•	Configure database connectors to query/update the database.
•	Configure Java/Web service connectors to invoke Java classes /web services from Teamwork’s.
Environment: IBM Business Process Manager V7.5 \Lombardi and BPMN V2.0.XML, Web services, Java Script and Core Java.
...
•	Production release, deployment and support.
Environment: Websphere Portal 7, Websphere Content Manager 7, RAD 8.0, DOJO, JQuery, DB2, PUMA API,WCM API, JSP, Servlet, Ajax.
...
Description: Aim of this project was to remediate the old morello based content site to IBM Websphere Content Management System. The Intranet site was developed on Websphere portal with rich user interface using Websphere portal web 2.0 capabilities. 
...
Environment: Portlet 286 with Portal6.1, Web Content Management 6.1, PUMA API, DB2 , JDBC, Java 1.5, JSP, Servlet, JSTL1.1, JavaScript, JQuery.
...
Description - Aim of this project was to remediate the old NYSL site into Websphere portal with rich user interface using Websphere portal capabilities. The application was created for verifying payout information (the mainframe data feed coming to oracle database) using custom portlets for the winning numbers of all the draws and creating WCM content to display the information on live site. This project was also aimed to remediate the PHP related pages of nysl to host on Websphere Portal server.
...
Environment: Portlet 286 with Spring MVC 2.5 Portal6.1,  Web Content Management 6.1, PUMA API, Orcale10g, JDBC, Java 1.5, JSP, Servlet, JSTL1.1, JavaScript , JQuery, Logging, Linux.
...
Description - Aim of this project was to Database Transition to Active Directory - Migration of the authentication process  and customer information from Oracle database to Microsoft Active Directory LDAP. 
...
•	Defect fixing and resolution
Environment: Portlet 286 with Spring MVC 2.5.6 on Portal6.1, Orcale10g, Hibernate 3, Soap WebServices, JUnit 4.5, Java 1.5, JSP, Servlet, JSTL1.1, Logging, Maven 2.1.0,  iText, DisplayTag, Puma Service, LDAP, DOJO1.3
...
Description: The application was designed to create reports to analyze sales and expenses across the countries within the company and at various stages to analyze by weeks, monthly or yearly wise to take correct decisions. Reports were also designed for file tracking, discount tracking, credit memo tracking and distribution tracking based on the given data by the business users.
...
National Retail Systems envisioned the development of a Shipment tracking and a pickup/delivery notification system, which had to be integrated with several other backend applications in to a single front end platform for the users. 
...
Environment: IBM WebSphere Web Component Management 6.0, Portal Express
...
Description: Claims Easy Query enabled users to query the actuarial claims database in a more user-friendly fashion. 
...
Certification
Certified SAFe 5 Scrum Master – March 2020
ReactJS Developer - Certified By PluralSight
...
Education: Master’s degree in Software Engineering (5 year Integrated). in 2006 from Cochin University, Kerala, India
